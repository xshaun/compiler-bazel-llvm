...
elif [[ -n $(rlocation clang-llvm-10.0.0-conda-centos-x86_64/bin/clang-import-test) ]]; then
  $(rlocation clang-llvm-10.0.0-conda-centos-x86_64/bin/clang-import-test) "$@"
else
