...
elif [[ -n $(rlocation clang-llvm-10.0.1-rc1-x86_64-pc-linux-gnu/bin/llvm-symbolizer) ]]; then
  $(rlocation clang-llvm-10.0.1-rc1-x86_64-pc-linux-gnu/bin/llvm-symbolizer) "$@"
else
